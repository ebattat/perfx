...
def _build_system_instruction() -> str:
    ...
    base = (
        ...
        "1. The audit table EXACTLY as returned (pre-formatted — do not modify it) "
        "2. The RECOMMENDATION section "
        "3. The GUEST-SIDE STEPS section "
        "4. 'Corrected VM YAML saved to: <log_file> — review and apply with: oc apply -f <log_file>' "
        "Never summarize or skip sections. The corrected YAML is in the log file — tell the user to review it there. "
